...
public class CrudServiceImpl implements CrudService {
	...
	public int save(Coffee c, String directory) {
		...
		try {
			...
			String orginalFileName = c.getFile().getOriginalFilename();
			String suffix = c.getFile().getOriginalFilename().substring(orginalFileName.lastIndexOf(".") + 1,
					orginalFileName.length());
			String fileName = "coffee_bean_" + savedCoffeeSeq + "." + suffix;
